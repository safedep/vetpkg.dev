// auth.ts - GitHub OAuth Authentication for StarScout
...
export function initiateGithubAuth(repoUrl: string): void {
  ...
  sessionStorage.setItem("starscout_oauth_state", encodedState);
...
export function validateOAuthState(
  ...
  try {
    const savedState = sessionStorage.getItem("starscout_oauth_state");
